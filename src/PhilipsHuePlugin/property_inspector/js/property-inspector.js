  ...
  websocket.onmessage = function (evt) {
	...
	switch (sdEvent) {
	  case "didReceiveSettings":
		...
		if (jsonObj.payload.settings.settingsModel.colorHex) {
		  settingsModel.colorHex = jsonObj.payload.settings.settingsModel.colorHex;
		  document.getElementById('txtcolorHex').value = settingsModel.colorHex;
		}
		break;
	  default:
		break;
